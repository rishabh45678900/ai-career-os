...
// Validate ../../app/api/chat/resume/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/chat/resume">> = Specific
  const handler = {} as typeof import("../../app/api/chat/resume/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
